...
namespace BESHOPDIENTHOAI.Controllers
{
    ...
    public class CouponsController : ControllerBase
    {
        ...
        public CouponsController(ShopDienThoaiContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Coupon>> PostCoupon(Coupon coupon)
        {
          if (_context.Coupons == null)
          {
              return Problem("Entity set 'ShopDienThoaiContext.Coupons'  is null.");
          }
            _context.Coupons.Add(coupon);
            await _context.SaveChangesAsync();

            return CreatedAtAction("GetCoupon", new { id = coupon.IdCoupon }, coupon);
        }
        ...
        {
            return (_context.Coupons?.Any(e => e.IdCoupon == id)).GetValueOrDefault();
        }
    }
}
